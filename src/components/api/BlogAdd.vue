                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <BaseInput name="title" :placeholder="'enter title'"
                            :servererror="addBlogStore.validationErrors?.title" />
                    </div>
                    ...
                    <div>
                        ...
                        <BaseInput name="content" :placeholder="'enter content'"
                            :servererror="addBlogStore.validationErrors?.content" />
                    </div>
                    ...
                    <div>
                        ...
                        <BaseInput name="category" type="select" label="category"
                            :servererror="addBlogStore.validationErrors?.category">
                            <option value="" selected class="dark:bg-slate-800">Select category</option>
                            <option v-for="cat in categoryList.category" :key="cat.id" :value="cat.name"
                    ...
                    <div>
                        ...
                        <BaseInput name="image" :placeholder="'upload image'" type="file"
                            :servererror="addBlogStore.validationErrors?.image"></BaseInput>
...
import { addBlogApi } from '@/store/blog/blogAddApi';
...
const handleAddBlog = async (data) => {
    ...
    try {
        await addBlogStore.addBlog(data);
        toast.success(`addBlogStore.notification`, { position: "top-right", transition: "slide", autoClose: 500 });
